...
import illustrationintro from '../assets/images/illustrationintro.png'
  ...
  return (
    <div className='hero'>
        <ol className='nav'>
          ...
          Access them wherever you need, share and collaborate with friends faimly, and co-workers.</p>
